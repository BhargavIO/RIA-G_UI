...
<script>
	...
	function imageIsLoaded(e) {
		...
		org_x=document.getElementById("left").width;
		org_y=document.getElementById("left").height;
		x = 922;
		y = 692;
		$(".left").attr('width', x);
		$(".left").attr('height',y);
					...
					<div class="row">
						...
						<div class="row" style="width: 100%; margin: 0 auto;">
							...
							<table style="margin-top: 0px;float:right">
								...
								<tr>
									<td>
										<button class="file-upload success" style="width: 190px;">
											<input type="file" class="file-input file-upload success"
												name="lefteyefile" id="lefteyefile" onclick="" required
												style="">Choose Image(.jpg)
										</button>
									</td>
								</tr>
								<tr>
									<td><input type="submit" value="Upload"
										class="button success" disabled="true" /></td>
								</tr>
								<tr>
